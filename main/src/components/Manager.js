    ...
    <ul className="list-group" id="list">
      <div className="center">
        <li className="list-group-item" aria-disabled="true">
          <b>Your Account Address:</b> {account}
        </li>
        <li className="list-group-item">
          <b> Winner : </b>
          {lwinner}
          <button className="btn btn-primary button1" onClick={winner}>
            Click To Generate Winner
          </button>
        </li>
        <li className="list-group-item">
          <b>Balance : </b> {cbalance} ETH
          <button className="btn btn-primary button1" onClick={contractBalance}>
            Click To Know Contract Balance
          </button>
        </li>
      </div>
    </ul>
